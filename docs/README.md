...
| `next-phase-plan.md` | แผนเฟสถัดไป — งาน A (ย้ายคลัง) และงาน B–E (บทเสริม stat arb) พร้อมสถานะ · ปิดครบแล้ว |
| `regression-pca-plan.md` | แผนอุดช่องว่างเนื้อหา regression กับ PCA — งาน F–I พร้อมผลสำรวจข้อมูลจริงที่รันไว้แล้ว |
